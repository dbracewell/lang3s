        ...
        .map((r) => (
          <Fragment key={r.id}>
            <details className="group flex w-full flex-col px-2 py-1 first:pt-3">
              <summary className="bg-row cursor-pointer gap-2 border px-2 py-1 font-medium group-open:sticky group-open:top-0 group-open:border-b-0 dark:bg-zinc-900">
                {r.name}{" "}
              </summary>
              <div className="bg-row text-muted-foreground flex max-h-[200px] flex-col items-center gap-4 border-x px-5 pb-2 text-sm font-medium md:flex-row dark:bg-zinc-900">
                <h3>
                  {formatCount(
