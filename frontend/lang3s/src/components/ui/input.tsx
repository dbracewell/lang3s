  ...
  return (
    <input
      ...
      className={cn(
        ...
        "focus-visible:border-slate-400 focus-visible:ring-2 focus-visible:ring-slate-300 focus-visible:outline-0! dark:focus-visible:border-slate-800 dark:focus-visible:ring-slate-800",
